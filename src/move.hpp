...
enum class MoveFlags : u16 {
    ...
    promo_knight         = (0b1000 | (static_cast<u16>(PieceType::knight) - 2)) << 12,
    promo_bishop         = (0b1000 | (static_cast<u16>(PieceType::bishop) - 2)) << 12,
    promo_rook           = (0b1000 | (static_cast<u16>(PieceType::rook) - 2)) << 12,
    promo_queen          = (0b1000 | (static_cast<u16>(PieceType::queen) - 2)) << 12,
    promo_capture        = 0b1100 << 12,
    promo_knight_capture = (0b1100 | (static_cast<u16>(PieceType::knight) - 2)) << 12,
    promo_bishop_capture = (0b1100 | (static_cast<u16>(PieceType::bishop) - 2)) << 12,
    promo_rook_capture   = (0b1100 | (static_cast<u16>(PieceType::rook) - 2)) << 12,
    promo_queen_capture  = (0b1100 | (static_cast<u16>(PieceType::queen) - 2)) << 12,
};
