...
// clang-format off
inline const PParam PAWN_MAT   = S(281, 446);
inline const PParam KNIGHT_MAT = S(956, 1001);
inline const PParam BISHOP_MAT = S(974, 1066);
inline const PParam ROOK_MAT   = S(1452, 1806);
inline const PParam QUEEN_MAT  = S(3184, 3277);
inline const PParam TEMPO_VAL  = S(36, 16);

inline const PParam BISHOP_PAIR_VAL  = S(73, 196);
...
inline const PParam PAWN_THREAT_KNIGHT = S(194, 71);
inline const PParam PAWN_THREAT_BISHOP = S(181, 76);
inline const PParam PAWN_THREAT_ROOK = S(159, 50);
inline const PParam PAWN_THREAT_QUEEN = S(125, -66);
