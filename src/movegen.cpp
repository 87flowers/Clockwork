...
void MoveGen::generateMoves(MoveList& moves) {
    ...
    const u16 valid_plist   = m_position.pieceList(active_color).raw.nonzero8();
    ...
    write(moves, at, active & enemy & promo_zone, pawn_mask, MoveFlags::promo_queen);
    write(moves, at, active & enemy & promo_zone, pawn_mask, MoveFlags::promo_knight);
    write(moves, at, active & enemy & promo_zone, pawn_mask, MoveFlags::promo_rook);
    write(moves, at, active & enemy & promo_zone, pawn_mask, MoveFlags::promo_bishop);
